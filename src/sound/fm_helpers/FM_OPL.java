...
public class FM_OPL {
    ...
    public int /*UINT8*/ address;
    /* address register                  */
    public int /*UINT8*/ status;
    /* status flag                       */
    public int /*UINT8*/ statusmask;
    /* status mask                       */
 ...
 /* LFO */
    ...
    public OPL_TIMERHANDLERPtr TimerHandler;
    /* TIMER handler   */
    public int TimerParam;
    /* TIMER parameter */
    public OPL_IRQHANDLERPtr IRQHandler;
    /* IRQ handler    */
    public int IRQParam;
    /* IRQ parameter  */
    public OPL_UPDATEHANDLERPtr UpdateHandler;

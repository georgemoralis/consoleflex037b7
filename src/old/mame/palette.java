...
public class palette {
    ...
    /* RGB palette as set by the driver. */
    public static UBytePtr new_palette;
    /* changes to the palette are stored here before */
 /* being moved to game_palette by palette_recalc() */
    ...
    public static UBytePtr just_remapped;
    /* colors which have been remapped in this frame, */
 /* returned by palette_recalc() */
    ...
    public static char[] shrinked_palette;
    public static char[] palette_map;
    /* map indexes from game_palette to shrinked_palette */
    ...
    public static int palette_start() {
        ...
        if (Machine.drv.color_table_len != 0) {
            Machine.game_colortable = new char[Machine.drv.color_table_len * 2];//malloc(Machine->drv->color_table_len * sizeof(unsigned short));
 ...
 /* we'll need the usage arrays to help in shrinking. */
            ...
            pen_visiblecount = new IntSubArray((int) (2 * Machine.drv.total_colors * 4));//malloc(2 * Machine->drv->total_colors * sizeof(int));
            ...
            for (int i = 0; i < Machine.drv.total_colors * 4; i++) {
 ...
 /* drivers_old which dynamically change the palette don't need a vh_init_palette() */
...
/*            int oldword = paletteram.READ_WORD(offset);
    ...
    public static void changecolor_RRRRGGGGBBBBIIII(int color, int data) {
        int i, r, g, b;

 ...
 * modifications are done for mess 0.37b6
 */
package old.mame;
...
import static old.mame.drawgfxH.GfxDecodeInfo;
...
public class driverH {
    public static class MachineCPU {
        public MachineCPU(int ct, int cc, MemoryReadAddress[] mr, MemoryWriteAddress[] mw,
                          IOReadPort[] pr, IOWritePort[] pw,
                          InterruptPtr vb, int vbf, InterruptPtr ti, int tif, Object reset) {
            cpu_type = ct;
            cpu_clock = cc;
            memory_read = mr;
            memory_write = mw;
        ...
        public MachineCPU(int ct, int cc, MemoryReadAddress[] mr, MemoryWriteAddress[] mw,
                          IOReadPort[] pr, IOWritePort[] pw,
                          InterruptPtr vb, int vbf, InterruptPtr ti, int tif) {
            this(ct, cc, mr, mw, pr, pw, vb, vbf, ti, tif, null);
        }

        public MachineCPU(int ct, int cc, MemoryReadAddress[] mr, MemoryWriteAddress[] mw,
                          IOReadPort[] pr, IOWritePort[] pw, InterruptPtr vb, int vbf) {
    ...
    public static final int CPU_TMS9900 = 49;
    public static final int CPU_TMS9940 = 50;
    public static final int CPU_TMS9980 = 51;
    public static final int CPU_TMS9985 = 52;
    public static final int CPU_TMS9989 = 53;
    public static final int CPU_TMS9995 = 54;
    public static final int CPU_TMS99105A = 55;
    public static final int CPU_TMS99110A = 56;
    public static final int CPU_Z8000 = 57;
    public static final int CPU_TMS320C10 = 58;
    public static final int CPU_CCPU = 59;
    public static final int CPU_PDP1 = 60;
    public static final int CPU_ADSP2100 = 61;
    public static final int CPU_ADSP2105 = 62;
    public static final int CPU_MIPS = 63;
    public static final int CPU_SC61860 = 64;
    public static final int CPU_ARM = 65;
    public static final int CPU_COUNT = 66;

    /* set this if the CPU is used as a slave for audio. It will not be emulated if */
    /* sound_old is disabled, therefore speeding up a lot the emulation. */
    ...
    public static final int MAX_SOUND = 5;	/* MAX_SOUND is the maximum number of sound_old subsystems */
    ...
    public static class MachineDriver {
        ...
        public MachineDriver(MachineCPU[] mcp, float fps, int vblank, int cpu_slices, InitMachinePtr im,StopMachinePtr sm, int sw, int sh, rectangle va, GfxDecodeInfo[] gdi, int tc, int ctl, VhConvertColorPromPtr vccp, int vattr, VhEofCallbackPtr veof, VhStartPtr vsta, VhStopPtr vsto, VhUpdatePtr vup, int sattr, int obs1, int obs2, int obs3, MachineSound[] snd, nvramPtr nvr) {
            this(mcp, fps, vblank, cpu_slices, im,sm, sw, sh, va, gdi, tc, ctl, vccp, vattr, veof, vsta, vsto, vup, sattr, obs1, obs2, obs3, snd);
            nvram_handler = nvr;
        }
        ...
        public StopMachinePtr stop_machine;//for consoleflex
    ...
    /* Mish 181099:  See comments in vidhrdw_old/generic.c for details */
    ...
    public static final int GAME_NO_SOUND = 0x0040;	/* sound_old is missing */
    public static final int GAME_IMPERFECT_SOUND = 0x0080;	/* sound_old is known to be wrong */

 ...
 * adjustments for mess 0.37b6
 */
package old.mame;

import cpu.z80.z80;
import old.cpu.m6809.m6809;
import old.cpu.Dummy_cpu;
import WIP.cpu.m6502.m6502;
import WIP.cpu.m6502.n2a03;
import WIP.cpu.i8039.i8035;
import WIP.cpu.i8039.i8039;
import WIP.cpu.i8039.i8048;
import WIP.cpu.i8039.n7751;
import WIP.cpu.i8085.i8085;
import WIP.cpu.i8085.i8080;
import WIP.cpu.m6805.m6805;
import WIP.cpu.m6805.m68705;
import WIP.cpu.m6805.HD63705;
import old.cpu.m6800.m6800;
import old.cpu.m6800.m6802;
import old.cpu.m6800.m6803;
import old.cpu.m6800.m6808;
import old.cpu.m6800.nsc8105;
import static WIP.cpu.i8085.i8085H.*;
import java.util.ArrayList;
import static WIP.mame.mame.Machine;
import static WIP.mame.mame.updatescreen;
import static WIP.mame.memory.memorycontextswap;
import old.cpu.hd6309.hd6309;

import static WIP.arcadeflex.fucPtr.*;
import static old.arcadeflex.osdepend.logerror;
import static old.cpu.m6809.m6809H.M6809_INT_FIRQ;
import static old.cpu.m6809.m6809H.M6809_INT_IRQ;
import static old.mame.cpuintrfH.*;
import static old.mame.driverH.*;
import static old.mame.inptport.inputport_vblank_end;
import static old.mame.inptport.update_input_ports;
import static WIP.mame.sndintrf.sound_reset;
import static mame.hiscore.hs_close;
import static mame.hiscore.hs_init;
import static mame.hiscore.hs_open;
import static mame.hiscore.hs_update;
import static old.cpu.m6809.m6809H.HD6309_INT_FIRQ;
import static old.cpu.m6809.m6809H.HD6309_INT_IRQ;
...
/*TODO*///	
    ...
    public static cpu_interface cpuintf[]
            = {
                ...
                new nsc8105(),/*TODO*///		CPU0(NSC8105,  nsc8105,  1,  0,1.00,NSC8105_INT_NONE,  NSC8105_INT_IRQ,NSC8105_INT_NMI,16,	  0,16,BE,1, 4,16	),
...
/*TODO*///
 ...
 /* execution of some CPUs, or disable interrupts */
            ...
            while (usres == 0) {
                ...
                if (have_to_reset != 0) {
                    if (Machine.drv.stop_machine!=null) (Machine.drv.stop_machine).handler();
                    continue reset;
                }

...
{	
	...
	public static final int NEC765_EXECUTION_PHASE_WRITE    = 4;*/
        ...
        */
        ...
        public static timer_callback nec765_seek_timer_callback = new timer_callback() {
        ...
        */
        ...
        static void     nec765_read_data()
        {
                ...
                if (!(floppy_drive_get_flag_state(fdc.drive, FLOPPY_DRIVE_READY) != 0))
                {
                        fdc.nec765_status[0] = (char)(0x0c0 | (1<<4) | fdc.drive | (fdc.side<<2));
        ...
        static void nec765_format_track()
        {
                ...
                nec765_setup_execution_phase_write(dr, 4);
        }
        ...
        if (VERBOSE){
                        logerror("NEC765: COMMAND: %02x\n",fdc.nec765_data_reg);
                                        ...
                                        fdc.nec765_command_bytes[0] = (char)fdc.nec765_data_reg;
        ...
        if (VERBOSE){
                                ...
                                fdc.nec765_command_bytes[fdc.nec765_transfer_bytes_count] = (char)fdc.nec765_data_reg;
                                fdc.nec765_transfer_bytes_count++;
                                fdc.nec765_transfer_bytes_remaining--;
        ...
        public static void     nec765_setup_command()
        {
                ...
                switch (fdc.nec765_command_bytes[0] & 0x01f)
                {
                        ...
                        case 0x04:  /* sense drive status */
                        {
                                ...
                                fdc.nec765_status[3] = (char) (fdc.drive | (fdc.side<<2));
                        ...
                        if ((fdc.nec765_flags & NEC765_INT) != 0)
                        {
                                ...
                                fdc.nec765_result_bytes[0] = fdc.nec765_status[0];
                                /* return pcn */
                                fdc.nec765_result_bytes[1] = (char) fdc.pcn[fdc.drive];
                                ...
                                switch (fdc.version)
                                {
                                        ...
                                        case SMC37C78:
                                        {
                                                ...
                                                switch (fdc.nec765_command_bytes[0] & 0x01f)
                                                {
                                                        ...
                                                        case 0x0e:
                                                        {
                                                                fdc.nec765_result_bytes[0] = (char) fdc.pcn[0];
                                                                fdc.nec765_result_bytes[1] = (char) fdc.pcn[1];
                                                                fdc.nec765_result_bytes[2] = (char) fdc.pcn[2];
                                                                fdc.nec765_result_bytes[3] = (char) fdc.pcn[3];

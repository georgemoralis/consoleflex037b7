...
public class tiaH {
	...
	*/
	...
	public static class COLREG {
		public int P0=0; /* player 0   */
		public int M0=0;	/* missile 0  */
		public int P1=0;	/* player 1   */
		public int M1=0;	/* missile 1  */
		public int PF=0;	/* playfield  */
		public int BL=0;	/* ball       */
		public int BK=0;	/* background */
	};


	/* keep a record of the playfield registers here */
	public static class PFREG {
		public int B0=0; /* 8 bits, only left 4 bits used */
		public int B1=0; /* 8 bits  */
		public int B2=0;	/* 8 bits  */
	};

	public int[] scanline_registers=new int[80]; /* array to hold info on who gets displayed */

...
import static WIP.mame.common.flip_screen_x;
...
public class commonH {
    ...
    public static class RomModule {
        ...
        public int offset;
        /* offset to load it to */        //UINT32!!!
        public int length;
        /* length of the file */          //UINT32!!!
        public int crc;
 ...
 /* the macros below. */
    public static final int ROMFLAG_MASK = 0xfc000000;
    /* 6 bits worth of flags in the high nibble */

 /* Masks for individual ROMs */
    public static final int ROMFLAG_ALTERNATE = 0x80000000;
    /* Alternate bytes, either even or odd, or nibbles, low or high */
    public static final int ROMFLAG_WIDE = 0x40000000;
    /* 16-bit ROM; may need byte swapping */
    public static final int ROMFLAG_SWAP = 0x20000000;
    /* 16-bit ROM with bytes in wrong order */
    public static final int ROMFLAG_NIBBLE = 0x10000000;
    /* Nibble-wide ROM image */
    public static final int ROMFLAG_QUAD = 0x08000000;
    /* 32-bit data arranged as 4 interleaved 8-bit roms */
    public static final int ROMFLAG_OPTIONAL = 0x04000000;
    /* Optional ROM, not needed for basic emulation */
